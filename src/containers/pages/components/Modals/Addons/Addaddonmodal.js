...
export class Addaddonmodal extends Component {
    ...
    handleSubmit = (event) =>{
        ...
        const {hideModal,modalprops:{addNewAddon}} = this.props;
        
        addNewAddon({name, category,description,image,cost});
        hideModal()
    };
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    <td>
                                        <div id="imageholder">
                                            <img id="profile" name="profile" src={addon_image} className="theImage" alt="profilepic"/>
