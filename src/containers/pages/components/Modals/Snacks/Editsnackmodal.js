...
export class Editsnackmodal extends Component {
    ...
    handleSubmit = (event) =>{
        ...
        let {modalprops:{snack:{name,description,category,image,snackDetails:{shape,tiers,weight,flavour,cost}}}} = this.props;
        ...
        const {hideModal,modalprops:{editSnack,snack:{_id}}} = this.props;

        editSnack(_id,{name, category,description,image,snackDetails:{flavour,weight,cost,shape,tiers}});
        hideModal()
      };

    render() {
        const {categories,hideModal,modalprops:{snack:{name,description,category,image,snackDetails:{shape,tiers,weight,flavour,cost}}}} =this.props;
        const { errorMessage, spinner } =this.props;
        
        return (
            <div className="editsnackmodal" onClick={hideModal}>
...
export default connect(mapStateToProps, mapDispatchToProps)(Editsnackmodal);