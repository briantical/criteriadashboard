...
const snack_image = require('../../../../../assets/snack.png')

const storageService = firebase.storage();
const storageRef = storageService.ref();

export class Addsnackmodal extends Component {
    ...
    render() {
        ...
        return (
            <div className="addsnackmodal" onClick={hideModal}>
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    <td>
                                        <div id="imageholder">
                                            <img id="profile" name="profile" src={snack_image} className="theImage" alt="profilepic"/>
...
export default connect(mapStateToProps, mapDispatchToProps)(Addsnackmodal)